...
\begin{tikzpicture}
  ...
  \node[transition] (t0) at ($(p0)!0.5!(p1)$) [label={above:$T_0$}] {}
  edge[pre] (p0)
  edge[post] (p1);
  \node (c0) at ($(p0)!0.5!(p1)-(0,7mm)$) [align=center, text width= 1cm] {
    \ssmall
    $[2, \infty]$
    $<2>$
    \par
  ...
  \node[transition] (t1) [right =3mm of p1, label={above:$T_1$}] {}
  edge[pre] (p1);
  \node (c1) [right =3mm of p1, xshift=-4mm, yshift=-7mm, align=center, text width= 1cm] {
    \ssmall
    $[2, 4]$
    $<1>$
    \par

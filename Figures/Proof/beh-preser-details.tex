...
\begin{tikzpicture}
  ...
  \node (sigfepoint) [draw,circle,fill=black,inner sep=1pt] at ($(sigppoint.south)!.66!(sigspoint.north)$) {};
  ...
  \node[anchor=west] at ($(sigpoint)!0.5!(siginjrpoint)$) {\fontsize{4}{6}\selectfont $\mathtt{Inject_\uparrow}$};
  \node[anchor=west] at ($(siginjrpoint)!0.5!(sigrepoint)$) {\fontsize{4}{6}\selectfont $\uparrow$};
  \node[anchor=west] at ($(sigrepoint)!0.5!(sigppoint)$) {\fontsize{4}{6}\selectfont $stabilize$};
  \node[anchor=west] at ($(sigppoint)!0.5!(siginjfpoint)$) {\fontsize{4}{6}\selectfont $\mathtt{Inject_\downarrow}$};
  \node[anchor=west] at ($(siginjfpoint)!0.5!(sigfepoint)$) {\fontsize{4}{6}\selectfont $\downarrow$};
  \node[anchor=west] at ($(sigfepoint)!0.5!(sigspoint)$) {\fontsize{4}{6}\selectfont $stabilize$};
  ...
  \path[draw,->]
  ($(sigppoint.south)-(0,2pt)$) -- ($(siginjfpoint.north)+(0,3pt)$);

  \path[draw,->]
  ($(siginjfpoint.south)-(0,2pt)$) -- ($(sigfepoint.north)+(0,3pt)$);

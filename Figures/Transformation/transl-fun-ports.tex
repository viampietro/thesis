...
\begin{tikzpicture}
  ...
  \node[draw, black, inner sep=2mm, % minimum height=4cm, minimum width=3cm
    ...
    \begin{tikzpicture}      
      ...
      \node[draw, black, inner sep=2mm] (compP0) {$P_0$};
      ...
      \node[draw, black, inner sep=2mm] (compT0) at ($(compP0)+(1.5,-1.5)$) {$T_0$};
      ...
      \node[draw, black, inner sep=2mm] (compP1) at ($(compT0)-(1.5,1.5)$) {$P_1$};
      ...
      \node[draw, black, inner sep=2mm] (compT1) at ($(compP1)+(-1.5,1.5)$) {$T_1$};
      \node at ($(compT1.north)-(.5,0)$) {\fontsize{4}{6}\selectfont\itshape in};
      \node at ($(compT1.south)-(.55,0)$) {\fontsize{4}{6}\selectfont\itshape out};
      ...
      \node[draw, black] (actionps) at ($(compP1.south west)-(1,1)$) {action};
      \node[draw, black] (funps) at ($(compP1.south east)+(1,-1)$) {function};
  ...
  \node (labelportc0) at ($(portc0.north)+(0,6pt)$) {$c_0$};
  \node (labelportc1) at ($(portc1.north)+(0,6pt)$) {$c_1$};
  ...
  \node (labelporta0) at ($(porta0.south)-(0,6pt)$) {$a_0$};
  \node (labelporta1) at ($(porta1.south)-(0,6pt)$) {$a_1$};
  \node (labelportf0) at ($(portf0.south)-(0,6pt)$) {$f_0$};
  ...
  \node(vhdllabel) at ($(vhdl.south)-(0,.8)$) {VHDL top-level design};

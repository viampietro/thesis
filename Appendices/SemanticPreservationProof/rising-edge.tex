...
\begin{niproof}
  ...
  \item Assuming that $t\in{}Sens(s'.M)$, let us show
    ...
    \item \textbf{CASE} $input(t)=\emptyset$:
      ...
      \InCsCompT{}, we can deduce $\Delta(id_t)("ian")=1$ and
      $\sigma'(id_t)("iav")[0]=\mathtt{true}$.

      Thanks to $\Delta(id_t)("ian")=1$, we can deduce that $i=0$.

      Rewriting the goal with $\sigma'(id_t)("iav")[0]=\mathtt{true}$,
      \qedbox{tautology.}
    ...
    \item \textbf{CASE} $input(t)\neq\emptyset$:\\
      ...
      deduce $\Delta(id_t)("ian")=\vert{}input(t)\vert$.
      
      Thanks to $\Delta(id_t)("ian")=\vert{}input(t)\vert$, we know
      ...
      $\sigma'(id_t)("iav")[i]=\sigma'(id_{ji})=\sigma'(id_p)("oav")[j]$.
      ...
      \item \textbf{CASE} $pre(p,t)=(\omega,\mathtt{basic})$:\\
        ...
        we can deduce $\sigma'(id_p)("oat")[j]=\mathtt{basic}$ and
        $\sigma'(id_p)("oaw")[j]=\omega$.

        Rewriting the goal with
        $\sigma'(id_p)("oat")[j]=\mathtt{basic}$
        and $\sigma'(id_p)("oaw")[j]=\omega$, and simplifying the goal:\\
        \fbox{$\sigma'(id_p)("sm")\ge\omega=\mathtt{true}$.}

        \noindent{}Appealing to Lemma~\ref{lem:re-equal-marking}, we
        can deduce $s'.M(p)=\sigma'(id_p)("sm")$.
      ...
      \item \textbf{CASE} $pre(p,t)=(\omega,\mathtt{inhib})$:
        ...
        \InCsCompP, we can deduce
        $\sigma'(id_p)("oat")[j]=\mathtt{inhib}$ and
        $\sigma'(id_p)("oaw")[j]=\omega$.

        \noindent{}Rewriting the goal with
        $\sigma'(id_p)("oat")[j]=\mathtt{inhib}$ and
        $\sigma'(id_p)("oaw")[j]=\omega$, and simplifying the goal:
  ...
  \item Assuming that $\sigma'(id_t)("s\_enabled")=\mathtt{true}$, let
    ...
    \item Assuming
      ...
      $\prod\limits_{i=0}^{\Delta(id_t)("ian")-1}\sigma'(id_t)("iav")[i]=\mathtt{true}$.
      ...
      \noindent{}Thanks to $\Delta(id_t)("ian")=\vert{}input(t)\vert$,
      we can deduce that
      ...
      \noindent{}Thanks to
      $\sigma'(id_t)("iav")[i]=\sigma'(id_{ji})=\sigma'(id_p)("oav")[j]$,
      we can deduce that $\sigma'(id_p)("oav")[j]=\mathtt{true}$.
      ...
      \noindent{}Thanks to $\sigma'(id_p)("oat")[j]=\mathtt{basic}$,
      $\sigma'(id_p)("oaw")[j]=\omega$, and simplifying
    ...
    \item Assuming $pre(p,t)=(\omega,\mathtt{inhib})$, let us show
      ...
      \noindent{}By property of the stabilize relation and \InCsCompP,
      we can deduce $\sigma'(id_p)("oat")[j]=\mathtt{inhib}$ and
      $\sigma'(id_p)("oaw")[j]=\omega$.

      \noindent{}Thanks to $\sigma'(id_p)("oat")[j]=\mathtt{inhib}$
      and $\sigma'(id_p)("oaw")[j]=\omega$, and simplifying
      Equation~\eqref{eq:sens-true}, we can deduce

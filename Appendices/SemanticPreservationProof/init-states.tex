...
\begin{niproof}
  ...
  Rewriting $s_0.cond(c)$ as $false$, by definition of $s_0$,
  \fbox{$\sigma_0(id_c)=false$.}

  By construction, $id_c$ is an input port identifier of Boolean type
  in the \hvhdl{} design $d$, and thus, by property of the \hvhdl{}
  elaboration relation, we can deduce $\sigma_e(id_c)=false$.
...
\begin{niproof}
  ...
  Rewriting $s_0.ex(f)$ as $false$, by definition of $s_0$,
  \fbox{$\sigma_0(id_f)=false$.}

  By construction, $id_f$ is an output port identifier of Boolean type
  in the \hvhdl{} design $d$, and thus, by property of the \hvhdl{}
  elaboration relation, we can deduce $\sigma_e(id_f)=false$.

...
\begin{proof}
  ...
  \begin{itemize}
  \item Apply the \nameref{lem:init-states-eq-marking} lemma to solve \ref{it:marking-eq}.
  \item Apply the \nameref{lem:init-states-eq-tc} lemma to solve \ref{it:tc-eq}.
  \item Apply the \nameref{lem:init-states-eq-rorders} lemma to solve \ref{it:reset-eq}.
  \item Apply the \nameref{lem:init-states-cond-vals} lemma to solve \ref{it:cond-eq}.
  \item Apply the \nameref{lem:init-states-act-exec} lemma to solve \ref{it:action-eq}.
  \item Apply the \nameref{lem:init-states-fun-exec} lemma to solve \ref{it:fun-eq}.
  \end{itemize}
\end{proof}
...
\begin{proof}
  ...
  $\sigma_0(id_p)=\sigma_p^0,$ let us show that\\
  \framebox{$s_0.M(p)=\sigma_p^0("s\_marking")$.}\\

  \noindent{}By construction and by definition of $id_p$, there exist

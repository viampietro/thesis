...
first version, we have also implemented a SITPN interpreter (a
so-called \emph{token player}) and proved that the interpreter was
sound and complete w.r.t the SITPN semantics. This first
implementation of the SITPNs and the formal proof of soundness and
completeness are available at
\url{https://github.com/viampietro/sitpns}.

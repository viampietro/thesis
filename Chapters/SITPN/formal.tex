...
\begin{definition}[Time transitions]
...
\begin{notation}[SITPN state and fields]
  ...
  time counter associated with the transition $t$ at state $s$.
\end{notation}
...
the premises of Definition~\ref{def:semantics}:
...
boundedness of a SITPN model is a mandatory condition to prove the

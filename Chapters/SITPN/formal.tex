...
definition of a fired transition at a given SITPN state:
...
given transition $t$, the $Pr$ set of $t$ represents all the
...
marking for a given transition $t$ and at a given SITPN state $s$.
...
yet overreached the upper bound of their associated time interval. Of
...
bound of their associated time interval. Of course, time counters can
never be locked in the presence of an infinite upper bound. In
...
\begin{definition}[Conflict]
  ...
  conflict if there exists a place $p\in{}P$ such that

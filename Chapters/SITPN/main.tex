...
\begin{figure}[H]
  \centering
  \includegraphics[keepaspectratio,width=.3\linewidth]{pictures/struct-conflict-with-basic}
...
Contrary to the statement made in \cite[p. 67]{Leroux14}, we no more
...
\begin{figure}[H]
  \centering
  \includegraphics[keepaspectratio,width=.4\linewidth]{pictures/conflict-not-trans}

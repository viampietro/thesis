...
appears in in \textcolor{Green}{green} at Step~2. Due to the firing of
...
newly activated as $p_1$ is marked. The value of time counters are
...
\begin{figure}[H]
  ...
  conflicting transitions.]{Computation of the residual marking for a
    ...
    \textcolor{red}{red} to indicate that its current value is
    \texttt{false}.}

...
\begin{definition}[Elaborated Design]
  ...
  \item $Gens\in{}generic\mhyphen{}id\rightarrow{}(type\times{}value)$
    where $generic\mhyphen{}id=\{id~\vert~(id,\tau,e)\in{}gens\}$, is
    the function yielding the type and the value of generic constants.
  \item $Ins\in{}input\mhyphen{}id\rightarrow{}type$ where
    $input\mhyphen{}id=\{id~\vert~(\mathtt{in},id,\tau)\in{}ports\}$,
    is the function yielding the type of input ports.
  \item $Outs\in{}output\mhyphen{}id\rightarrow{}type$ where
    $output\mhyphen{}id=\{id~\vert~(\mathtt{out},id,\tau)\in{}ports\}$,
    is the function yielding the type of output ports.
  \item
  ...
  \item
    ...
    is the function associating processes to their local
  ...
  \item
    ...
    is the function mapping component instance identifiers to their
    own elaborated design version. The set $ElDesign(d_e,\mathcal{D})$
...
\begin{definition}[Design state]
  ...
  \item
    ...
    is the function yielding the current state of component instances,
    where $\Delta_c=\Delta(id_c)$ and $id_c\in{}component\mhyphen{}id$
    is the component identifier passed to the $\mathcal{C}$ function.
  \item
...
\begin{notation}[No events design state]
  ...
  design state similar to the one passed in parameter but with an

...
As in \cite{VanTassel95}, we define the \emph{design} construct in the
$\mathcal{H}$-VHDL's abstract syntax which has no equivalent in the
concrete syntax of VHDL.
...
\begin{table}[H]
  \begin{tabular}{lcl}
    ...
    e & ::= & e \texttt{and} e | e \texttt{or} e | \texttt{not} e | e \texttt{=} e | e $\neq$ e | e \texttt{<} e | e \texttt{<=} e | e \texttt{>} e | e \texttt{>=} e | e \texttt{+} e | e \texttt{-} e \\

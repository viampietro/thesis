...
(CIS): the instantiation of a component instance
\cite[p.139]{VHDL2000} and the instantiation of a design entity
\cite[p.141]{VHDL2000}. The component instantiation statement used in
the \hvhdl{} abstract syntax corresponds to the instantiation of a
design entity.

...
caption={[A component instantiation statement in \hvhdl{} abstract syntax (transition component instance).] An example of instantiation of the transition design in \hvhdl{} abstract syntax. The transition component instance is named $id_t$.},framexleftmargin=1.5em,xleftmargin=2em,numbers=left,
numberstyle=\tiny\ttfamily]

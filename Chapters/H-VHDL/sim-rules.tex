...
$\sigma_i$ and $\sigma'_i$. These definitions are expressed
as side conditions.
...
\begin{table}[H]
  ...
  \begin{prooftree}[template=\inserttext]
    ...
    % Rising
    \hypo{$\mathcal{D},\Delta,\sigma_i\vdash\mathrm{cs}\xrightarrow{\uparrow}\sigma_r$}

    % Stabilize after rising.
    \hypo{$\mathcal{D},\Delta,\sigma_r\vdash\mathrm{cs}\xrightarrow{\rightsquigarrow}\sigma'$}
    
    % Falling
    \hypo{$\mathcal{D},\Delta,\sigma'_i\vdash\mathrm{cs}\xrightarrow{\downarrow}\sigma_f$}

    % Stabilize after falling.
    \hypo{$\mathcal{D},\Delta,\sigma_f\vdash\mathrm{cs}\xrightarrow{\rightsquigarrow}\sigma''$}
...
\begin{table}[H]
  \centering
  \begin{tabular}{@{}l}
    {\fontsize{10}{13}\selectfont\textsc{CompRunInitEvents}} \\
    {\begin{prooftree}
...
\begin{table}[H]
  \centering
  \begin{tabular}{@{}l}
    {\fontsize{10}{13}\selectfont\textsc{CompRunInitNoEvent}} \\
    {\begin{prooftree}
...
\begin{table}[H]
  \centering
  \begin{tabular}{@{}l}
    {\fontsize{10}{13}\selectfont\textsc{CompREEvents}} \\
    {\begin{prooftree}[template=\inserttext]
...
\begin{table}[H]
  \centering
  \begin{tabular}{@{}l}
    {\fontsize{10}{13}\selectfont\textsc{CompRENoEvent}} \\
    {\begin{prooftree}[template=\inserttext]
...
\begin{table}[H]
  \centering
  \begin{tabular}{@{}l}
    {\fontsize{10}{13}\selectfont\textsc{CompFEEvents}} \\
    {\begin{prooftree}[template=\inserttext]
...
\begin{table}[H]
  \centering
  \begin{tabular}{@{}l}
    {\fontsize{10}{13}\selectfont\textsc{CompFENoEvent}} \\
    {\begin{prooftree}[template=\inserttext]
...
\begin{table}[H]
  {\fontsize{10}{13}\selectfont\textsc{PsCombUnstable}}
...
\begin{table}[H]
  \centering
  \begin{tabular}{@{}l}
    {\fontsize{10}{13}\selectfont\textsc{CompCombEvents}} \\
    {\begin{prooftree}[template=\inserttext]
...
\begin{table}[H]
  \centering
  \begin{tabular}{@{}l}
    {\fontsize{10}{13}\selectfont\textsc{CompCombNoEvent}} \\
    {\begin{prooftree}[template=\inserttext]
...
\begin{table}[H]
  \begin{tabular}{@{}l}
    ...
    {\begin{prooftree}
        ...
        % Checks that the current value of [id__s] complies with T.
        \hypo{\mathcal{S}(id_s)\in_c{}T}
...
\begin{table}[H]
  \begin{tabular}{@{}l}
    ...
    {\begin{prooftree}
        ...
        \hypo{v&\in_c{}T}
        \infer[no rule]1{v_i&\in_c{}\mathtt{nat}(n,m)}
        \infer[no rule]1{\mathcal{S}(id_s)&\in_c{}\mathtt{array(}T,n,m\mathtt{)}}
...
\begin{table}[H]
  \begin{tabular}{@{}l}
    ...
    {\begin{prooftree}
        ...
        % Checks that val complies with T.
        \hypo{val\in_c{}T}

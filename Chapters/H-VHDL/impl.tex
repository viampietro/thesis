...
relation implements the \texttt{Inject}$_\downarrow$ and
\texttt{Inject}$_\uparrow$ relations. Line~18 states that the
$\sigma_i$ state is the result of the injection of the map
\coqe|($E_p$ $\tau$ $\uparrow$)| in the signal store of state
$\sigma$.

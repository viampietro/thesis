...
\label{sec:expr-transf}

\begin{itemize}
\item Literature review on compiler verification, model-to-model and
  model-to-text transformation verification
\item Additional questions that the lit. review results try to give an
  answer to:
  \begin{itemize}
  \item How to implement the transformation function to ease proof verification?
  \item How to implement the transformation function to make it extensible? modular?
    (thinking about new elements added to the source model)
  \end{itemize}
\end{itemize}

...
Here, all branches of the tree (there is only one branch here) has
...
set of identifiers). To evaluate the arithmetic expressions, we need a
state $s\in\mathtt{string}\rightarrow{}\mathbb{N}$ that maps each

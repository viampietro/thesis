...
case, structural induction is often referred to as \textit{functional}
...
\begin{niproof}
  ...
  Then, given an $X'\subset{}X$ and an $x\in{}X$
  s.t. $X=\{x\}\cup{}X'$, and assuming that
  $P(X',\sum\limits_{x'\in{}X'}2x')$ holds (i.e. the induction
  \textit{hypothesis}), let us show

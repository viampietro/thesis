...
\begin{thm}[Big Operator Equality]
  ...
  \item there exists an injection $\iota\in{}B\rightarrow{}C$
    s.t. $\forall{}b\in{}B,c\in{}C,~\iota(b)=c\Rightarrow{}f(b)=g(c)$
...
\begin{proof}
  ...
  \item \textbf{INDUCTION CASE} $B\neq\emptyset$:
    \begin{ih}
      ...
      \begin{itemize}
      \item $\exists{}\iota'\in{}B\setminus\{b\}\rightarrow{}C'~s.t.~$
        $\iota'$ is injective and
        $\forall{}b'\in{}B\setminus\{b\},c'\in{}C',~\iota'(b')=c'\Rightarrow{}f(b')=g(c')$
    ...
    \item
      \fbox{\parbox{\linewidth}{$\exists{}\iota'\in{}B\setminus\{b\}\rightarrow{}C\setminus\{\iota(b)\}~s.t.~$
          $\iota'$ is injective and
          $\forall{}b'\in{}B\setminus\{b\},c'\in{}C\setminus\{\iota(b)\},~\iota'(b')=c'\Rightarrow{}f(b')=g(c')$}}
    \end{enumerate}
    Let us define a
    ...
    \noindent{}By definition of $\iota(b')$, there are 2 cases:
    \begin{itemize}
    ...
    \item
      \fbox{$\forall{}b'\in{}B\setminus\{b\},c'\in{}C\setminus\{\iota(b)\},~\iota'(b')=c'\Rightarrow{}f(b')=g(c')$.}

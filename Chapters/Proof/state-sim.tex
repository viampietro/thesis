...
the meaning of semantic preservation between an SITPN and an \hvhdl{}
...
Section~\ref{sec:sitpn-state}). An \hvhdl{} design state is composed a
...
generated alongside the transformation from an SITPN to an \hvhdl{}
...
state and an \hvhdl{} design, is defined as follows:
...
$\texttt{s\_time\_counter}$ signal can not overreach the upper bound
...
in an \hvhdl{} design state. However, to complete the proof of semantic
...
must be compared between an SITPN state and an \hvhdl{} design state

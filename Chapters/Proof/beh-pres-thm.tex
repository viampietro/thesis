...
appealing to Lemma~\ref{lem:fst-re}. The detailed proofs for
Lemmas~\ref{lem:sim-init-states} and \ref{lem:fst-re} are given in
Sections~\ref{sec:init-states} and \ref{sec:fst-re}.

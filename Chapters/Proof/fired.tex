...
input port denotes the weigth of the arc between place $p$ and
...
equivalence holds, ie:
$t_i\in{}Fired(s')\Leftrightarrow\sigma'(id_{t_i})("fired")=\mathtt{true}$. Unfornately,

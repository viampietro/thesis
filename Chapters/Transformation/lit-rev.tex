...
HDLs. However, one should notice that compiling a HDL program into a
...
Step~3 in the \hilecop{} methodology, i.e. the transformation of VHDL
source code into a RTL representation.
...
Verilog programs into netlists targetting given FPGA models. Verilog
...
arcs have LLVM constructs for colour domains. Places are labelled with
...
define data structures (multisets, sets, markings,...)  with

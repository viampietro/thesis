...
types. The \texttt{nextid} field (Line~\ref{line:nextid}) permits to
...
transitions of $p$ that are conflict in the manner of the
...
\texttt{tconflict} field is filled with the ordered list.
...
identifiers passed as parameters as its entity and architecture
...
state \texttt{s}. Finally, the \texttt{beh} field fills the behavior
of the \hvhdl{} design.
